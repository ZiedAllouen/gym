...
console.log(exercisesData);
  ...
  return (
    <Stack alignItems="center" mt="37px" justifyContent="center" p="20px">
      <Typography  color="#f48915" fontWeight={700}sx={{fontSize:{lg:'44px',xs:'30px'}}} mb="50px" textAlign="center">
Exercices You Should Try
      </Typography>
      <Box position="relative" mb="72px">
        ...
        <Button className="search-btn" sx={{bgcolor:'#f48915',color:'#fff',textTransform:'none',width:{lg:'175px',xs:'80px'},fontSize:{lg:'20px',xs:'14px'},height:'56px',position:'absolute',right:'0'}} onClick={handleSearch}>
          search
        </Button>
      </Box>
